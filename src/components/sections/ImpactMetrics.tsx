...
function MetricCard({
  ...
  const displayValue =
    metric.value >= 1000 ? count.toLocaleString() : count.toString();
...
export default function ImpactMetrics() {
  ...
  const verifiedMetrics = impactMetrics
    .filter((m) => m.source === "verified")
    .slice(0, 6);
  ...
  return (
    ...
    >
      <div className="container-yge">
        ...
        >
          Figures shown are based on publicly documented YGE activities and will
          be updated as verified reporting becomes available. Figures marked
          &ldquo;Demo figure&rdquo; are estimates pending confirmation.
        </p>
      </div>
    </section>
  );
