...
export default function ManifestoSection() {
  ...
  return (
    ...
    >
      ...
      <div className="py-4 border-b border-black/15 overflow-hidden bg-black/5" aria-hidden="true">
        <div className="marquee-track flex whitespace-nowrap">
          <span className="font-display font-800 text-3xl sm:text-5xl uppercase tracking-tight pr-6" style={{ color: 'var(--color-forest-ink)' }}>
            {REPEATED}
          </span>
          <span className="font-display font-800 text-3xl sm:text-5xl uppercase tracking-tight pr-6" style={{ color: 'var(--color-forest-ink)' }}>
            {REPEATED}
      ...
      <div className="container-yge py-16 sm:py-24 relative z-10">
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            >
              Bangladesh faces acute climate pressures — rising sea levels, riverbank erosion, extreme weather, and urban pollution. Youth for a Green Earth exists because young Bangladeshis refuse to accept environmental destruction as our inevitable future.
            </motion.p>
          </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            >
              ...
              <span className="my-0.5 text-sm text-[var(--color-forest-ink)]">&darr;</span>
              <span>Awareness</span>
            ...
            >
              <h3 className="font-display font-700 text-lg" style={{ color: 'var(--color-forest-ink)' }}>
                Why Bangladesh?
              </h3>
              <p className="text-xs leading-relaxed" style={{ color: 'var(--color-deep-moss)' }}>
                As one of the world&apos;s most climate-vulnerable nations, Bangladesh is on the frontlines of global ecological change. Our youth-led initiatives show how local resilience can inspire action worldwide.
              </p>
            </motion.div>
          </div>
        </div>
