      ...
      <div className="container-yge">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p
              className="text-body-lg leading-relaxed max-w-xl"
              style={{ color: "rgba(245,241,231,0.85)" }}
            >
              Eco Papers is YGE&apos;s open-access publication series —
              independent environmental research, field insights and policy
              ideas written and designed by Bangladesh&apos;s youth.
            </p>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      >
                        Author: {paper.author} &middot; Designer:{" "}
                        {paper.designer}
                      </p>
                    </div>
                  </div>
            ...
            <div className="relative w-full max-w-sm aspect-[3/4]">
              {ecoPapers.slice(0, 2).map((paper, index) => (
                <div
                  ...
                  style={{
                    transform: index === 0 ? "rotate(-4deg)" : "rotate(7deg)",
                  }}
                >
                  <Image
