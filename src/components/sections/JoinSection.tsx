...
const pathways = [
  { icon: Heart, label: 'Become a Volunteer', href: '/contact#contact-form', color: 'var(--color-climate-coral)' },
  { icon: Building2, label: 'Bring YGE to Your Campus', href: '/contact#contact-form', color: 'var(--color-electric-teal)' },
  { icon: Handshake, label: 'Partner With YGE', href: '/contact#contact-form', color: 'var(--color-future-violet)' },
];
            ...
            {pathways.map((p, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Icon size={18} aria-hidden="true" style={{ color: p.color }} />
                    {p.label}
                  </Link>
                </motion.div>
              );
