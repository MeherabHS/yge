      ...
      <header className="story-article-header">
        <div className="container-yge story-article-container">
          <Link href="/stories" className="story-header-back">
            <ArrowLeft size={16} strokeWidth={1.8} aria-hidden="true" /> All
            Stories
          </Link>
          {story.type && (
            <span className="story-header-category">{story.type}</span>
          )}
          <h1>{story.title}</h1>
        ...
        <div className="container-yge story-article-container">
          <div className="story-article-layout">
            ...
            <article className="story-article-main">
              ...
              {story.pullQuote && (
                <blockquote
                  id="article-pull-quote"
                  className="article-pull-quote"
                >
              ...
              <nav
                className="article-story-navigation"
                aria-label="Story navigation"
              >
                {previousStory ? (
                  <Link
                    href={`/stories/${previousStory.slug}`}
                    className="article-story-previous"
                  >
                    <span>
