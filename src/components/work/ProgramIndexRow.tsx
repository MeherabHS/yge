...
export default function ProgramIndexRow({
  program,
  index,
}: {
  program: Program;
  ...
  return (
    <article
      className={`program-index-row ${index % 2 ? "index-tone-dark" : "index-tone-paper"}`}
    >
      <span className="program-index-number">
