...
export const metadata: Metadata = {
  ...
  description: 'Impact stories, field notes, campaign updates and announcements from Youth for a Green Earth.',
};

export default function StoriesPage() {
  const featured = getFeaturedStory() ?? stories[0];
  const archiveStories = featured ? stories.filter((story) => story.slug !== featured.slug) : stories;
  ...
  return (
    <div className="stories-index-page">
      ...
      <div className="stories-transition" aria-hidden="true">
        <div className="container-yge stories-transition-inner"><span /></div>
      </div>
