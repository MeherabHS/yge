...
import { eventArchiveFrames, getPublicEventGalleryPhotos } from '@/content/event-gallery';
import { getEventBySlug } from '@/content/events';

export const metadata: Metadata = {
  title: 'Events | Youth for a Green Earth',
  description: 'Explore Youth for a Green Earth events, gatherings and environmental competitions in Bangladesh.',
};
