...
export default function ResourcesPage() {
  ...
  return (
    ...
    >
      {/* Editorial Hero */}
      <section
        className="section-pad pt-36 pb-16 grain"
        style={{
          backgroundColor: "var(--color-future-violet)",
      ...
      >
        <div className="container-yge max-w-4xl">
          ...
          <p className="text-body-lg text-white/80 max-w-2xl leading-relaxed">
            Toolkits, educational materials, field reports and open publications
            produced by Youth for a Green Earth.
          </p>
        </div>
      </section>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-display font-700 text-xl text-[var(--color-paper-white)]">
                Looking for YGE Eco Papers?
              </h3>
              <p className="font-mono text-xs text-[var(--color-muted-sage)]">
                Explore our dedicated publication series &amp; issue archives.
              </p>
            </div>
          </div>
          <Link
      ...
      <div className="py-8 border-b border-black/10">
        <div className="container-yge flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
          <div className="relative max-w-md w-full">
            <Search
              size={16}
              className="absolute left-4 top-1/2 -translate-y-1/2 text-[var(--color-muted-sage)]"
            />
            <input
              type="search"
            ...
            {filtered.map((r) => (
              ...
              >
                ...
                <div className="space-y-4 p-8">
                  ...
                  <h2 className="font-display font-800 text-2xl text-[var(--color-forest-ink)]">
                    {r.title}
                  </h2>
                  <p className="font-mono text-xs text-[var(--color-muted-sage)]">
                    Author: {r.author}
                  </p>
                  <p className="text-sm font-body leading-relaxed text-[var(--color-charcoal)]">
                    {r.description}
                  </p>
                </div>
