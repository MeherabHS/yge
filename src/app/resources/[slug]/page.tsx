  ...
  return (
    <div style={{ backgroundColor: "var(--color-paper-white)" }}>
      ...
      <section
        ...
        aria-label={`${resource.title} hero`}
      >
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(280px,420px)]">
            <div className="min-w-0">
              ...
              >
                ...
                {resource.designer && `· Design: ${resource.designer}`}
              </p>
            </div>
            <div
              className="relative w-full overflow-hidden bg-white/5 shadow-2xl"
              style={{ aspectRatio: resource.coverAspectRatio ?? "3 / 4" }}
            >
              <Image
      ...
      <section className="section-pad">
        <div className="container-yge max-w-3xl">
          ...
          {resource.pdfPath ? (
            ...
            >
              <Download size={16} aria-hidden="true" /> Download Full Document
              (PDF)
            </a>
          ) : (
            <div
