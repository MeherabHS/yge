  ...
  return (
    <div style={{ backgroundColor: "var(--color-paper-white)" }}>
      ...
      <section
        ...
        aria-label={`${program.title} hero`}
      >
        <div className="container-yge">
          <Link
            href="/work"
            className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-wider mb-8 hover:opacity-75 transition-opacity"
          ...
          <div className="max-w-4xl">
            ...
            <h1
              className="font-display font-800 text-hero leading-tight tracking-tight mb-6"
        ...
        <div className="container-yge">
          <div className="grid lg:grid-cols-3 gap-16">
            ...
            <aside className="space-y-8">
              ...
              >
                <p
                  className="font-display font-700 text-base mb-4"
