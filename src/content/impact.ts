...
export const impactMetrics: ImpactMetric[] = [
  ...
  },
  {
    ...
    value: 55,
    description:
      "Children from Classes 1–5 engaged through Little Green Artists at Nakhalpara Hossain Ali High School.",
    source: "verified",
  ...
  },
  {
    ...
    value: 3,
    description:
      "Locations documented under Plastic Awareness 1.0: Dhaka, Sreemangal and Khagrachari.",
    source: "verified",
  ...
  },
  {
    ...
    value: 2,
    description:
      "Environmental research publications produced by YGE contributors.",
    source: "verified",
  ...
  },
  {
    ...
    value: 3,
    description:
      "Environmental film and documentary titles produced or associated with YGE.",
    source: "verified",
  ...
  },
  {
    ...
    value: 9,
    description:
      "Environmental programs and initiatives delivered since founding.",
    source: "demo",
  },
  {
    id: "volunteers",
    ...
    value: 40,
    description:
      "Approximate number of youth volunteers who have contributed to YGE activities.",
    source: "demo",
  },
];
...
export const impactLocations: ImpactLocation[] = [
  {
    ...
    lng: 90.4125,
    activities: [
      "Little Green Artists",
      "Plastic Awareness 1.0",
      "Climate Strike",
      "Eid Smile 2025",
    ],
  },
