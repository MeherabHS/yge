...
export const aboutThemes: AboutTheme[] = [
  {
    ...
    summary:
      "We make environmental and geographical challenges understandable, relevant and visible to young people and their communities.",
  ...
  },
  {
    ...
    summary:
      "We help young people understand how climate change affects ecosystems, health, security, livelihoods and Bangladesh’s changing landscapes.",
  ...
  },
  {
    ...
    summary:
      "We connect education with practical opportunities for youth-led advocacy, collaboration, innovation and community action.",
  ...
  },
  {
    ...
    summary:
      "We encourage young people to participate in protecting ecosystems, conserving resources and creating environmentally responsible communities.",
...
export const verifiedAboutThemes = aboutThemes.filter(
  (theme) => !theme.requiresVerification,
);

export const aboutTimeline: TimelineItem[] = [
  {
    period: "2024",
    title: "YGE established",
    description: "Youth for a Green Earth begins its work in Bangladesh.",
  },
  {
    period: "2024",
    title: "Youth climate advocacy",
    description:
      "Youth perspectives are organized around COP29 climate demands.",
  },
  {
    period: "2024",
    title: "Creative climate work",
    description:
      "Photography and documentary programs bring environmental stories into view.",
  },
  {
    period: "2025",
    title: "Education in action",
    description:
      "Little Green Artists connects nature, art and the 3Rs in Dhaka.",
  },
  {
    period: "2026",
    title: "Building forward",
    description:
      "Green Genesis brings youth climate learning and competition together.",
  },
];
...
export const aboutValues: AboutValue[] = [
  {
    ...
    title: "Educate",
    description:
      "We make environmental knowledge accessible, relevant and actionable for young people.",
    color: "paper",
    illustration: "book",
  },
  {
    ...
    title: "Organize",
    description:
      "We create youth-led networks and spaces where environmental voices can connect.",
    color: "coral",
    illustration: "people",
  },
  {
    ...
    title: "Create",
    description:
      "We use art, film, publishing and storytelling to turn climate knowledge into public conversation.",
    color: "paper",
    illustration: "camera",
  },
  {
    ...
    title: "Advocate",
    description:
      "We bring youth perspectives into climate discussions and public action.",
    color: "cobalt",
  ...
  },
  {
    ...
    title: "Act",
    description:
      "We turn awareness into practical community and campus initiatives.",
    color: "violet",
    illustration: "leaf",
  },
];

export const verifiedAboutTimeline = aboutTimeline.filter(
