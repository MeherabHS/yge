...
const statusCopy: Record<number, Omit<ErrorPageContent, "status">> = {
  400: {
    ...
    title: "Bad request.",
    message:
      "The request could not be understood. Check the address or return to a known page.",
  },
  401: {
  ...
  402: {
    ...
    message:
      "This request cannot be completed under its current access requirements.",
  },
  403: {
  ...
  404: {
    ...
    message:
      "The page you're looking for does not exist, has moved or is no longer available.",
  },
  405: {
  ...
  408: {
    ...
    message:
      "The request took too long to complete. Try again when the connection is stable.",
  },
  409: {
  ...
  410: {
    ...
    message:
      "This resource has been permanently removed and no replacement is available.",
  },
  413: {
  ...
  422: {
    ...
    message:
      "The request was understood, but some of its information could not be processed.",
  },
  429: {
    eyebrow: "Traffic Limit",
    title: "Too many requests.",
    message:
      "Too many requests arrived in a short period. Wait a moment before trying again.",
  },
  451: {
  ...
  500: {
    ...
    message:
      "The site encountered an unexpected problem. Try again or return to the homepage.",
  },
  501: {
    eyebrow: "Feature Notice",
    title: "Not implemented.",
    message:
      "This service does not currently support the requested functionality.",
  },
  502: {
    eyebrow: "Network Error",
    title: "Bad gateway.",
    message:
      "A service needed to complete this request returned an invalid response.",
  },
  503: {
  ...
  504: {
    ...
    message:
      "A service needed to complete this request did not respond in time.",
  },
  505: {
    eyebrow: "Protocol Error",
    title: "HTTP version not supported.",
    message:
      "This browser or request uses an HTTP version that the site cannot support.",
  },
  507: {
    eyebrow: "Storage Error",
    title: "Insufficient storage.",
    message:
      "The service does not currently have enough storage to complete this request.",
  },
  508: {
    eyebrow: "Routing Error",
    title: "Loop detected.",
    message:
      "The request entered a processing loop and could not be completed safely.",
  },
  511: {
    eyebrow: "Network Access",
    title: "Authentication required.",
    message:
      "The network requires authentication before this request can continue.",
  },
};
...
export function getErrorPageContent(status: number): ErrorPageContent | null {
  ...
  return status < 500
    ? {
        ...
        message:
          "The server could not complete this request. Check the address or return to a known page.",
      }
    : {
        status,
        ...
        message:
          "The service encountered a problem while processing this request. Please try again.",
      };
}
